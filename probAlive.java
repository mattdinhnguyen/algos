...
class ProbabilityOfAlive {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Alive probability = " + aliveProb(2, 2, 5, 5));
    System.out.println("Alive probability = " + aliveProb(2, 2, 5, 4));
    System.out.println("Alive probability = " + aliveProb(2, 2, 5, 3));
    System.out.println("Alive probability = " + aliveProb(2, 2, 5, 2));
  }
}
